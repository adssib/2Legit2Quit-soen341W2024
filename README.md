...
We are going to use a variety of front and backend frameworks to develop this prototype. Using different APIs and frameworks to communicate between front-end end and Backend 
